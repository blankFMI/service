...
public class CharacterControllerTest {
    ...
    public void testCreateCharacter() throws Exception {
        // Arrange:
        // Use the available four-argument constructor. Here we assume the parameter order is:
        // (id, name, background, personality). For a new character, we pass null as id.
        ...
        // Use an argument matcher to avoid matching issues caused by JSON deserialization.
